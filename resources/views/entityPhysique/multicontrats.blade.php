...
<body>
    ...
    <table>
        ...
        @foreach($contrats as $key => $contratvalue)
        <tr>
    ...
    <div class="container">
        <div class="center">
            <button onclick="window.location.href='http://127.0.0.1:8000/deletecontrat';">
                Delete
            </button> <button onclick="window.location.href='http://127.0.0.1:8000/afficheentityphysique';">
                Back
            </button>
            <button onclick="window.location.href='http://127.0.0.1:8000/AllContrats';">
                All Contrats
            </button>
        </div>
    </div>
